          ...
          <div className="space-y-4">
            {/* {courses
              ...
              .map((course) => (
                <div
                  key={course.id}
                  className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg hover:border-cardano-blue/50 transition-colors"
                >
                  <div className="w-12 h-12 bg-linear-to-r from-cardano-blue to-cardano-light rounded-lg flex items-center justify-center text-white text-xl">
                    {course.image}
                  </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
          ...
          <div className="space-y-4">
            {/* {certifications.map((cert) => (
              <div
                key={cert.id}
                className="p-4 border border-gray-200 rounded-lg hover:border-green-500/50 transition-colors"
              >
            ...
            {certifications.length === 0 && (
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm">
                  Completez un cours pour obtenir votre première certification
                  NFT.
                </p>
              </div>
            )}
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Completez ce cours pour débloquer votre prochaine certification
                NFT et apparaître dans la base de talents.
              </p>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  className="bg-linear-to-r from-cardano-blue to-cardano-light h-2 rounded-full transition-all duration-300"
                  style={{
                    width: `${courses.find((c) => c.id === 2)?.progress || 0}%`,
                  }}
                ></div>
              </div>
